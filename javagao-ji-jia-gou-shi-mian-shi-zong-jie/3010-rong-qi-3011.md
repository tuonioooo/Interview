...
扩容：ArrayList 和 Vector 都会根据实际的需要动态的调整容量，只不过在 Vector 扩容每次会增加 1 倍，而 ArrayList 只会增加上一次容量大小的一半50%。
...
**19.HashMap实现原理?**  [ **hashmap实现原理详解**](https://tuonioooo-notebook.gitbook.io/java-concurrent/hashmapshi-xian-yuan-li) ****

> **hashmap链表采用的是头插入方法**

**20.为什么要使用ConcurrentHashMap?**  [**参考答案**](https://tuonioooo-notebook.gitbook.io/java-concurrent/concurrenthashmapde-shi-xian-yuan-li-yu-shi-yong/wei-shi-yao-yao-shi-yong-concurrenthashmap)
